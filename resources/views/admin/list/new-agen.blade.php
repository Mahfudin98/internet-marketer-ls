<div class="modal fade new-agen" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @php
                                $i=1
                            @endphp
                            @forelse ($newMember->where('type', 'Agen')->where('status', 1) as $row)
                            <tr>
                                <th scope="row">{{ $i++ }}</th>
                                <td>{{ $row->name }}</td>
