        ...
        <div class="viewport-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb has-arrow">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Sosmed Form</li>
                </ol>
            </nav>
        </div>
        <div class="content-viewport">
            <div class="row">
                <div class="col-lg-6 equel-grid">
                    <div class="grid">
                        <p class="grid-header">Add Sosmed</p>
                        <div class="grid-body">
                            <div class="item-wrapper">
                                <form action="{{ route('member.sosmed.post') }}" method="POST">
                                    ...
                                    <div class="form-group row showcase_row_area">
                                        ...
                                        <input type="text" class="form-control" id="fb" name="fb" placeholder="Link Profile Facebook">
                                    </div>
                                    <div class="form-group row showcase_row_area">
                                        <label for="ig">Instagram</label>
                                        <input type="text" class="form-control" id="ig" name="ig" placeholder="Link Profile Instagram">
                                    </div>
                                    <div class="form-group row showcase_row_area">
                                        <label for="tt">Tiktok</label>
                                        <input type="text" class="form-control" id="tt" name="tt" placeholder="Link Profile Tiktok">
                                    </div>
                                    <div class="form-group row showcase_row_area">
                                        <label for="shopee">Shopee</label>
                                        <input type="text" class="form-control" id="shopee" name="shopee" placeholder="Link Profile Shopee">
                                    </div>
