                    ...
                    <form action="{{ route('anggota.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="province_id" id="province_id" data-width="fit"
                                            data-style="form-control form-control-lg" data-title="Pilih Provinsi" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="city_id" id="city_id" data-width="fit"
                                            data-style="form-control form-control-lg" data-title="Pilih Kabupaten" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="district_id" id="district_id" data-width="fit"
                                            data-style="form-control form-control-lg" data-title="Pilih Kecamatan" required>
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="cs_id" value="{{ Auth::user()->id }}">
                                    </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-success float-right"><i
                                    class="nav-icon fas fa-user-plus"></i> Add Anggota</button>
                        </div>
                    </form>
                </div>
            </div>
