...
@section('content_header')
    <h1 class="m-0 text-dark">Point</h1>
@stop
            ...
            <div class="row">
                ...
                <div class="col-md-{{ Auth::user()->roles == 'admin' ? '12' : '6' }}">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="item-wrapper">
                                <canvas id="chartjs-bar-chart" width="600"
                                    height="{{ Auth::user()->roles == 'admin' ? '250' : '505' }}"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            @forelse ($points as $rows)
                                                <tr>
                                                    <td>{{ $rows->name }}</td>
                                                    <td class="text-center">{!! !empty($rows->sosmeds[0]->point) ? $rows->sosmeds[0]->point : 'Belum Diatur' !!}</td>
                                                    <td>{{ $rows->type }}</td>
